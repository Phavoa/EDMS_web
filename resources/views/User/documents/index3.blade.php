      ...
      <div class="card z-depth-2">
        <div class="card-content">
          ...
          <div id="folderView">
            ...
            <br>
            <div class="row">
              @if(count($third_level_folder) > 0)
                @foreach($third_level_folder as $folder)
...
<!----------------------------------------------------------end---------------------->
              ...
              @if(count($thirdleveluploaddoc) > 0)
                @foreach($thirdleveluploaddoc as $folder)
                <div class="col m2 s6" id="tr_{{$folder->id}}">
                  <div class="card hoverable indigo lighten-5 task" data-id="{{ $folder->id }}">
                    <input type="checkbox" class="filled-in sub_chk" id="chk_{{$folder->id}}" data-id="{{$folder->id}}">
                    <label for="chk_{{$folder->id}}"></label>
...
<!----------------------------------------------------------end---------------------->
   ...
   <div id="modal2" class="modal">
        <div class="modal-content">
          ...
          <form action="{{url('/uploadoc_third_level')}}" method="post" enctype="multipart/form-data">
          @csrf
