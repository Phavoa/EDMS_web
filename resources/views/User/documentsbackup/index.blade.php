    ...
    <div class="col m11 s12">
      ...
      <div class="card z-depth-2">
        <div class="card-content">
          ...
          <button data-target="modal1" class="btn g-5 waves-effect waves-light modal-trigger right">Create Folder</button>
...
<!-- <div id="modal1" class="modal">
  <div class="modal-content">
    ...
    <form action="{{url('user/folders')}}" method="POST" enctype="multipart/form-data">
    @csrf
