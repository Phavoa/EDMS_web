        ...
        <div class="card-content">
          ...
          <div id="folderView">
            ...
            <div class="row">
                ...
                <div class="col m2 s6" id="tr_">
                  <div class="card hoverable indigo lighten-5 task" data-id="">
                    <input type="checkbox" class="filled-in sub_chk" id="chk_" data-id="">
                    <label for="chk_"></label>
                    <a href="">
